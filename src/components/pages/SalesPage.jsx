...
import { getNextNumberInvoice } from '../../actions/invoice';
...
export const SalesPage = () => {
  ...
  console.log(getNextNumberInvoice());

  const transactionData = {
    date: moment().format('DD/MM/YYYY'),
    controlNumber: getNextNumberInvoice(),
    deliveryMode: true,
  };
  ...
  return (
    <div className='container mt-5'>
      <div className='search-container'>
        {showInvoicePdf && (
          <GeneratePdfFromHtml WrappedComponent={Invoice} data={{ transactionData, activeCustomer, productsForSale }} />
        )}
        <SearchClient />
        <SearchProduct />
      </div>
